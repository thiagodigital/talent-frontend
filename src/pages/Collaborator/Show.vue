...
<template>
  ...
  <div class="max-w-lg px-5 mx-auto">
    ...
    <TabsComponent v-if="data.collaborator?.evaluations && data.collaborator.evaluations.length > 0">
      ...
      <TabComponent name="DISC" idx="4">
        ...
        >
        <ul>
          <li v-for="(trait, tIndex) in category.options" :key="tIndex" class="flex justify-between py-1 border-b last:border-b-0">
